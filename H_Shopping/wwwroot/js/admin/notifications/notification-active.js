(function ($) {
 "use strict";
            ...
            //Brand
            $('#basicSuccessAddBrand').on('click', function () {
                showNotification('success', 'Add new Brand successfully');
            });
            $('#basicErrorAddBrand').on('click', function () {
                showNotification('error', 'Add new Brand Failed');
            });

            $('#basicSuccessUpdateBrand').on('click', function () {
                showNotification('success', 'Update brand successfully');
            });
            $('#basicErrorUpdateBrand').on('click', function () {
                showNotification('error', 'Update Brand error');
            });

            //Category
            $('#basicSuccessAddCategory').on('click', function () {
                showNotification('success', 'Add new category successfully');
            });
            $('#basicErrorAddCategory').on('click', function () {
                showNotification('error', 'Add new category Failed');
            });

            $('#basicSuccessUpdateCategory').on('click', function () {
                showNotification('success', 'Update caregory successfully');
            });
            $('#basicErrorUpdateCategory').on('click', function () {
                showNotification('error', 'Update category error');
            });
